...
SAP.registerTopic({
  ...
  tanim: {
    ...
    muhasebeMantigi:
      ...
      'dönem kapalı. ⚠️ Rahatsız edicidir ama **iyi haberdir**: ' +
  ...
  surec: {
    ...
    roller:[
      ...
      { rol:'Danışman', gorev:'⚠️ {{akim-verisi}} tablolarını canlıda **ayrıca** ayarlar.' },
    ],
    ...
    diyagram:{
      ...
      adimlar:[
        { ic:'💬', rol:'İş tarafı', baslik:'İhtiyaç doğar',
          aciklama:'⚠️ İhtiyaç genelde **çözüm olarak** gelir: ' +
        ...
        { ic:'🔧', rol:'Danışman', baslik:'Geliştirme sisteminde yapılır',
          aciklama:'⚠️ Değişiklik **küçük ve amaç odaklı** bir ' +
        ...
        { ic:'🚚', rol:'BT', baslik:'{{STMS}} ile **sırayla** taşınır',
          aciklama:'⚠️ {{tasima-sirasi}} bozulursa **eski hâl yeniyi ezer** — ' +
                   've hiçbir hata mesajı çıkmaz.',
          cikti:'Canlıda ayar', ok:'doğrulanır' },
        { ic:'✅', rol:'Danışman', baslik:'⚠️ Canlıda **doğrulanır** — taşındı ≠ çalışıyor',
    ...
    adimlar:[
      ...
      { rol:'Danışman', eylem:'Canlıda doğrular', sistem:'⚠️ {{akim-verisi}} ayrı' },
    ],
    ...
    notlar:[
      { tip:'warn', baslik:'⚠️ "Test sisteminde çalışıyordu" — üç sebep', metin:
  ...
  muhasebe: {
    ...
    etkilenenHesaplar:[
      ...
      { hesap:'⚠️ 336 Diğer çeşitli borçlar', tur:'Bilanço — Kaynak', neden:'Yanlış `AKONT` ile buraya düşer.' },
    ...
    fisler:[
      { baslik:'① Yanlış {{mutabakat-hesabi}} — kayıt geçer, bilanço yanlış',
        ...
        satirlar:[
          ...
          { hesap:'336', ad:'⚠️ Diğer çeşitli borçlar — satıcı V-2087', alacak:120000,
            not:'`AKONT` yanlış girilmiş' },
        ],
        not:'⚠️ **Fiş dengeli, sistem kabul etti, hata mesajı çıkmadı.**\n\n' +
             ...
             '• ⚠️ Yaşlandırma ve {{F110}} çalışır — çünkü açık kalem yönetimi ' +
      ...
      { baslik:'② Düzeltme — ayar değişir, **geçmiş kalır**',
        ...
        not:'⭐ **Konunun özü bu fişte.**\n\n' +
             ...
             '⚠️ **Ama geçmiş kayıtlar taşınmaz.** Değişiklikten sonraki ' +
             ...
             '⚠️ Bu kaydın kendi bedeli de var: `336` ve `320` artık ' +
      ...
      { baslik:'③ Uyarı (W) seviyesinde bırakılmış kontrol — sessizce geçilir',
        ...
        satirlar:[
          { hesap:'770', ad:'Genel yönetim giderleri — ⚠️ kapatılmış kâr merkezi', borc:45000 },
        ...
        not:'Kâr merkezi kontrolü bir doğrulamayla kurulmuştu ama ' +
             ...
             '⚠️ **W ile kurulan kural, ilk yoğun günde herkes tarafından ' +
    ...
    notlar:[
      { tip:'err', baslik:'⚠️ Üç fişin ortak özelliği — ve neden bu konu var', metin:
        ...
        '⚠️ Yapılandırma kaynaklı olanlar **her belgeyi** etkiler ve ' +
  ...
  cesitler: {
    ...
    liste:[
      ...
      { ad:'🚪 {{hesap-plani}} — tek yönlü', en:'Chart of Accounts',
        ...
        ornek:'⚠️ **Neden geri alınamaz:** her belge bir hesaba yazılır. ' +
      ...
      { ad:'🚪 {{belge-bolme}} — tek yönlü', en:'Document Splitting',
        ...
        ornek:'⚠️ **Konunun en klasik tek yönlü kapısı.**\n\n' +
      ...
      { ad:'🚪 Şirket kodu para birimi — tek yönlü', en:'Company Code Currency',
        ...
        ornek:'⚠️ Her kalem hem işlem hem yerel para biriminde saklanır. ' +
      ...
      { ad:'🚪 {{mali-yil-varyanti}} — tek yönlü', en:'Fiscal Year Variant',
        ...
        neZaman:'Şirket kodu açılırken.',
        ornek:'⚠️ Dönem yapısı her belgenin `MONAT` alanına yazılmıştır. ' +
      ...
      { ad:'🚪 Defter yapısı ve {{amortisman-alani}} — tek yönlü', en:'Ledger / Depreciation Area',
        ...
        neZaman:'Kurulumda.',
        ornek:'⚠️ Bir deftere sonradan geçmiş yazılamaz: IFRS defteri ' +
      ...
      { ad:'🚪 Kullanılmış {{vergi-kodu}}nun oranı — tek yönlü', en:'Tax Code Rate',
        ...
        neZaman:'Oran değişikliğinde — ⚠️ **yeni kod açılır, eski değiştirilmez**.',
        ornek:'⚠️ Vergi kodu belgede **kod olarak** saklanır, oran olarak değil. ' +
      ...
      { ad:'🔁 {{odeme-kosulu}}, tolerans, alan durumu — çift yönlü', en:'Reversible Settings',
        ...
        ornek:'✅ Bunlar **hızlı** karar verilir ve gerekirse değiştirilir:\n\n' +
              ...
              '⚠️ **Dikkat:** değiştirmek serbesttir ama **geçmişi düzeltmez**. ' +
      ...
      { ad:'🚚 {{tasima-istegi}} — küçük ve amaç odaklı', en:'Transport Request',
        ...
        ornek:'**İyi istek:** tek bir amaç, birkaç nesne, açıklayıcı metin ' +
              ...
              '⚠️ **Kötü istek:** "FI ayarları" adlı, üç haftalık ' +
      ...
      { ad:'⚡ {{akim-verisi}} — taşınmayan yapılandırma', en:'Current Settings',
        ...
        ornek:'Örnekler: {{OB52}} dönem açma/kapama · {{TCURR}} döviz kurları · ' +
              ...
              '⚠️ Bir yetki sorusu doğurur: canlıda özelleştirme kapalıdır ama ' +
      ...
      { ad:'🧪 {{negatif-test}} — asıl değer burada', en:'Negative Testing',
        ...
        neZaman:'Her kontrol kurulduğunda — ⚠️ **istisnasız**.',
        ornek:'Mutlu yolu herkes test eder. Ama bir kontrol ' +
              ...
              '⚠️ **Neden zorunlu:** {{konu:dogrulama-ikame}}’de kural üç adımda ' +
    ...
    karsilastirma:[
      ...
      ['Karar hızı', '⚠️ **Yavaş** — yazılı, gerekçeli', '✅ Hızlı'],
      ['Kim karar verir?', '**İş tarafı** — danışman bilgi verir', 'Danışman önerir, iş onaylar'],
      ['Yanlışsa maliyet', '⚠️ **Yeni proje**', 'Bir ayar değişikliği'],
    ...
    liste:[
      { kod:'SE09', ad:'Taşıma organizatörü',
        ...
        adimlar:[
          ...
          { baslik:'Serbest bırak — önce **görev**, sonra **istek**',
            aciklama:'⚠️ Görev serbest bırakılmadan istek bırakılamaz.' },
          { baslik:'⚠️ Çakışma kontrolü: iki istek aynı nesneye dokunuyor mu?',
            aciklama:'{{tasima-sirasi}} sorunlarının teşhisi buradadır.' },
          { baslik:'Taşıma günlüğünü oku — ⚠️ **dönüş kodu 8 hata demektir**' },
        ],
        ekranAkisi:[
          { ekran:'İstek listesi', islem:'3 açık istek görüldü' },
          { ekran:'İçerik', islem:'İstek A: `T007A` (vergi kodu) · İstek B: `T007A` + `T030K`' },
          { ekran:'⚠️ Çakışma', islem:'**İkisi de `T007A`’ya dokunuyor** → sıra kritik' },
        ...
        hatalar:[
          ...
          { mesaj:'Taşındı ama canlıda etkisi yok', sebep:'⚠️ Tablo {{akim-verisi}} olabilir — taşımaya hiç girmemiştir.', cozum:'Canlıda **ayrıca** ayarlanır ({{SM30}} / {{OB52}}).' },
          { mesaj:'Dönüş kodu 8', sebep:'Taşıma hata verdi — bağımlı nesne eksik veya sözlük uyumsuzluğu.', cozum:'Günlük okunur. ⚠️ **Dönüş kodu 4 de masum değildir**: uyarıdır ama içerik eksik taşınmış olabilir.' },
        ],
      ...
      { kod:'STMS', ad:'Taşıma yönetim sistemi',
        ...
        adimlar:[
          ...
          { baslik:'Günlüğü oku — ⚠️ dönüş kodu 8 hatadır, 4 uyarıdır' },
          { baslik:'⚠️ Canlıda **doğrula** — taşındı ≠ çalışıyor' },
        ],
        ekranAkisi:[
        ...
        hatalar:[
          ...
          { mesaj:'"Sistemde özelleştirme kapalı"', sebep:'{{SCC4}} istemci ayarı — canlıda doğru davranış.', cozum:'Değişiklik **geliştirme sisteminde** yapılıp taşınır. ⚠️ İstisna: {{akim-verisi}}.' },
        ],
        ipucu:'⚠️ **Taşıma bir teslim değil, bir adımdır.** ' +
      ...
      { kod:'SPRO', ad:'Uygulama yapılandırması (IMG)',
        ...
        adimlar:[
          ...
          { baslik:'⚠️ İstek **küçük ve amaç odaklı** olsun' },
        ],
        ekranAkisi:[
        ...
        ipucu:'⭐ **IMG belgesini okumak, bu konudaki en yüksek getirili alışkanlıktır.**\n\n' +
              ...
              '⚠️ **sonradan değiştirilip değiştirilemeyeceğini** yazar.\n\n' +
  ...
  tablolar: {
    ...
    liste:[
      ...
      { ad:'TCURR', baslik:'Döviz kurları — akım verisi örneği',
        ...
        s4:'Değişmedi.',
        alanlar:[
          { ad:'GDATU', aciklama:'⚠️ Tarih **ters** saklanır — doğrudan okumayı zorlaştırır' },
    ...
    er:{
      ...
      varliklar:[
        ...
        { ad:'TCURR', rol:'Akım verisi', aciklama:'⚠️ **Taşınmaz** — her sistemde ayrı',
      ...
      iliskiler:[
        ...
        { from:'E071', to:'TCURR', alanlar:'—', not:'⚠️ **bağlantı yok** — akım verisi' },
      ],
    },
  },
  ...
  sapSurec: {
    ...
    ekranlar:[
      { ad:'{{SPRO}} — yapılandırma ağacı',
        ...
        alanlar:[
          ...
          { ad:'{{tasima-istegi}}', zorunlu:true, aciklama:'⚠️ Sorulmadıysa tablo ' +
                   '**{{akim-verisi}}**dir.' },
        ],
        ipucu:'IMG belgesini okumak bu konudaki **en yüksek getirili alışkanlıktır**.' },
      ...
      { ad:'{{STMS}} — kuyruk ve sıra',
        ...
        alanlar:[
          ...
          { ad:'Dönüş kodu', zorunlu:true, aciklama:'⚠️ 8 hata · 4 uyarı — ' +
                   '**4 de masum değildir**.' },
        ],
    ...
    hatalar:[
      ...
      { mesaj:'Taşıma RC 0 ama ayar canlıda eski hâlinde', sebep:'⚠️ Başka bir istek **sonra** taşınıp üzerine yazmış.', cozum:'{{E071}}’de ortak nesne aranır; doğru sırayla yeniden taşınır.' },
      ...
      { mesaj:'Kural kurdum ama çalışmıyor', sebep:'{{konu:dogrulama-ikame}}: **etkinleştirme adımı** atlanmış ({{GGB4}}).', cozum:'⚠️ {{negatif-test}} bunu yakalar; pozitif test **göremez**.' },
    ...
    ipuclari:[
      ...
      '⚠️ Taşımadan **önce** {{E071}} içeriğine bak, sonra değil.',
      ...
      '⚠️ {{akim-verisi}} tablolarını canlıda **ayrıca** ayarla ve **kimin yazabileceğini** seç.',
  ...
  teknik: {
    guncellenenTablolar:[
      ...
      { tablo:'TCURR', ne:'⚠️ {{akim-verisi}} — taşınmaz' },
    ],
    ...
    commit:
      ...
      '(bkz. {{konu:tcodes}}).\n\n' +
      '**2.** ⚠️ Yapılandırma değişikliği **çalışan işlemleri etkilemez** ' +
    ...
    postingLogic:
      ...
      '⚠️ Yanlışsa kayıt **geçer** — sessiz hata.\n\n' +
      '**3. Zorlayıcı mı?** Doğrulama kuralları, mesaj tipi (W/E), ' +
      'yetkilendirme. ⚠️ Zayıfsa kural **fiilen yoktur**.\n\n' +
    ...
    belgeTuru:
      ...
      '⚠️ Aşırıya kaçmamak gerekir: her senaryoya ayrı belge türü açmak ' +
    ...
    numberRange:
      ...
      'aralıklar **çakışamaz**.\n\n' +
      '⚠️ Ayrıca numara aralıkları çoğu sistemde **taşınmaz** — ' +
    ...
    accountDetermination:
      ...
      '⚠️ **Yanlış** → kayıt geçer, yanlış hesaba yazar. Sessiz hata.\n\n' +
    ...
    tur:
      ...
      'hızlı geçilir.\n\n' +
      '**⚙️ Teknik karar** — danışmana aittir (istek büyüklüğü, ' +
      'test kapsamı, adlandırma).\n\n' +
      '⚠️ **En sık karıştırılan:** teknik görünen bir kararın aslında ' +
    ...
    transport:
      ...
      '━━━━━━━━━━\n\n' +
      '⚠️ **Ve taşınmayan üç şey:** {{akim-verisi}} tabloları · ' +
    ...
    img:[
      ...
      { yol:'STMS → içe aktarma kuyruğu', not:'⚠️ **Bütün olarak** aktarılır' },
    ...
    ekstra:[
      ...
      { ic:'📝', baslik:'Dokümantasyon: SAP "ne"yi tutar, siz "neden"i tutun', metin:
        ...
        '⚠️ Bu, {{konu:dogrulama-ikame}}’deki *"kural 2024’te doğruydu"* ' +
      ...
      { ic:'🧪', baslik:'Test senaryosu yazımı — üç kural', metin:
        ...
        '⚠️ {{konu:mm-integration}}’deki OBYC hataları tam olarak ' +
    ...
    notlar:[
      { tip:'tip', baslik:'⭐ Z geliştirme bir maliyet değil, bir borçtur', metin:
        ...
        '• ⚠️ Ve en pahalısı: **{{konu:migration}}’da taşınma yükü**\n\n' +
        '━━━━━━━━━━\n\n' +
        ...
        '⚠️ Her yükseltmede {{SPAU}} ile elle ele alınır. **Faiz yüksek.**\n\n' +
        '━━━━━━━━━━\n\n' +
      ...
      { tip:'warn', baslik:'⚠️ Danışmanın en pahalı alışkanlığı: "sonra bakarız"', metin:
  ...
  s4hana: {
    ...
    eccFarklari:[
      ...
      { konu:'{{z-gelistirme}}', ecc:'Bakım maliyeti', s4:'⚠️ **Geçiş engeli** — {{basitlestirme-listesi}}’nde çıkar' },
      ...
      { konu:'Yeni tek yönlü kapı', ecc:'—', s4:'⚠️ {{is-ortagi}} numaralandırma stratejisi' },
    ],
    ...
    universalJournal:
      ...
      '⚠️ Ama dikkat: gereksizleşen kontrolü **kaldırmak** da bir karardır. ' +
    ...
    compatibilityViews:[
      '⚠️ Eski tabloları okuyan {{z-gelistirme}}ler {{uyumluluk-view}} ' +
    ...
    bestPractices:[
      ...
      '⚠️ {{z-gelistirme}} envanteri tut — artık bir **geçiş engeli**.',
      ...
      '⚠️ {{akim-verisi}} hâlâ taşınmıyor — canlıda ayrıca ayarla.',
    ],
  },
  ...
  senaryo: {
    ...
    veriler:[
      ...
      { k:'Belge bölme', v:'⚠️ **Kapalı** (bilinçli karar)' },
      ...
      { k:'⚠️ Olmayan', v:'İş kolu **bilançosu**' },
    ],
    ...
    adimlar:[
      { baslik:'Kâr merkezi bazlı bilanço alınamaz mı?', tcode:'FAGLB03',
        ...
        girdi:[
          ...
          { alan:'⚠️ Satıcılar (320)', deger:'**Boş**' },
          { alan:'⚠️ Alıcılar (120)', deger:'**Boş**' },
          { alan:'⚠️ Bankalar (102)', deger:'**Boş**' },
        ],
        not:'⭐ **{{konu:new-gl}}’deki temel ayrım burada somutlaşıyor.**\n\n' +
             ...
             '⚠️ Sorun **bilanço satırlarındadır**: satıcı, müşteri, banka, vergi. ' +
      ...
      { baslik:'Bölmeyi şimdi açsak?', tcode:'SPRO',
        ...
        girdi:[
          ...
          { alan:'Geçmiş belgeler bölünür mü?', deger:'⚠️ **Hayır**' },
          { alan:'{{FAGL_SPLINFO}} geçmiş kayıtlar', deger:'⚠️ **Boş — ve doldurulamaz**' },
          { alan:'Etki', deger:'Yalnızca **açıldığı tarihten sonraki** belgeler' },
        ],
        not:'⚠️ **Konunun tezi tam olarak burada.**\n\n' +
      ...
      { baslik:'Elle dağıtalım mı?', tcode:'FBL1N',
        ...
        girdi:[
          ...
          { alan:'Banka hareketleri', deger:'⚠️ **Çoğu ortak** — ayrıştırılamaz' },
          { alan:'Vergi kalemleri', deger:'⚠️ Ortak — oransal dağıtım gerekir' },
          { alan:'Sonuç', deger:'⚠️ **Yaklaşık** bilanço — denetlenemez' },
        ],
        not:'Teknik olarak kısmen mümkün: her satıcı faturasının ' +
             'gider satırındaki kâr merkezine bakılıp borç ona atanabilir.\n\n' +
             '⚠️ **Ama iki grup kalem ayrıştırılamaz:**\n\n' +
    ...
    sonuc:
      ...
      '━━━━━━━━━━\n\n' +
      '⚠️ Bu asimetri, konunun tamamının özetidir: ' +
  ...
  ogrenme: {
    ozet:[
      ...
      '⚠️ {{akim-verisi}} taşınmaz — *"test sisteminde çalışıyordu"*nun en sık sebebi.',
    ...
    sikHatalar:[
      ...
      { hata:'Ayarın değiştirilebilir olmasına bakıp "geri alınabilir" sanmak.', dogru:'⚠️ **Ayar geri alınabilir, veri geri alınamaz.** Asıl soru: kapalıyken üretilmeyen veri var mı?' },
      { hata:'Şüphedeyken ayarı kapalı kurmak.', dogru:'⭐ **Açık kur, kullanma.** Kullanılmayan defter/bölme neredeyse maliyetsizdir.' },
      { hata:'Yalnızca mutlu yolu test etmek.', dogru:'⚠️ Kontrol **yalnızca ihlal edildiğinde** görünür. {{negatif-test}} zorunludur.' },
      ...
      { hata:'Kritik kontrolü uyarı (W) seviyesinde bırakmak.', dogru:'⚠️ W ile kurulan kural ilk yoğun günde **fiilen kalkar**. Kritikse **E**.' },
      { hata:'Üç haftalık her şeyi tek taşıma isteğine koymak.', dogru:'Sorun çıkınca **geri alınamaz** — iyi değişiklikler de geri gider.' },
      { hata:'Taşıma kuyruğundan seçmeli aktarım yapmak.', dogru:'⚠️ Sırayı bozar. Kuyruk **bütün olarak** aktarılır.' },
      ...
      { hata:'{{akim-verisi}} tablolarını taşımaya güvenmek.', dogru:'⚠️ Taşınmazlar. {{OB52}} ve {{TCURR}} canlıda **ayrıca** ayarlanır.' },
      ...
      { hata:'Z geliştirmeyi tek seferlik maliyetle değerlendirmek.', dogru:'Bir **borçtur**: destek paketi, {{SPAU}}, devir ve ⚠️ geçiş engeli.' },
    ...
    ipuclari:[
      ...
      '⚠️ Taşımadan önce {{E071}}’de **çakışma** kontrol et.',
      ...
      '⚠️ Canlıda yapılandırma değişikliğini **yoğun saatlerde yapma**.',
    ...
    quiz:[
      { soru:'Bir yapılandırma kararının "tek yönlü kapı" olup olmadığını anlamanın en güvenilir yolu nedir?',
        ...
        aciklama:'⚠️ **Birinci seçenek en yaygın hatadır.** SAP’ta neredeyse ' +
      ...
      { soru:'Bir doğrulama kuralı kurdunuz. Testi nasıl yaparsınız?',
        ...
        aciklama:'⭐ **{{negatif-test}} — ve bu, test senaryolarının ' +
                 ...
                 '⚠️ Somut örnek: {{konu:dogrulama-ikame}}’de kural üç adımda ' +
      ...
      { soru:'Satıcının mutabakat hesabı (AKONT) yanlış girilmiş; 20 faturası yanlış hesaba gitmiş. Ana veriyi düzeltmek yeterli mi?',
        ...
        aciklama:'⭐ **"Ayarın geri alınabilirliği ≠ hatanın düzeltilebilirliği."**\n\n' +
                 ...
                 '(`336` borç / `320` alacak).\n\n' +
                 '⚠️ **Ve o kaydın da bir bedeli var:** düzeltme G/L seviyesinde ' +
      ...
      { soru:'Aynı vergi kodu tablosuna dokunan iki taşıma isteği ters sırada canlıya gitti. Ne olur?',
        ...
        aciklama:'⚠️ **{{tasima-sirasi}} sessiz bir hata sınıfıdır.**\n\n' +
      ...
      { soru:'Şüphedeyken (örneğin paralel defter ihtiyacı belirsizken) ne yapılır?',
        ...
        aciklama:'⭐ **"Şüphedeyken açık kur, kullanma."**\n\n' +
                 ...
                 '⚠️ ayar açılsa bile **geçmiş veri o bilgiyi kazanmaz**. ' +
