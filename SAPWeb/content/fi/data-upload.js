...
SAP.registerTopic({
  ...
  tanim: {
    ...
    gercekHayat:
      ...
      '**{{bapi}}** → ⚠️ tekrar çalıştırılabilirliği **sen kurgularsın**. ' +
    ...
    muhasebeMantigi:
      ...
      '⚠️ Muhasebede bu **çift kayıt** demektir: bakiye iki katına çıkar, ' +
  ...
  surec: {
    ...
    roller:[
      ...
      { rol:'Danışman', gorev:'⚠️ {{SM13}} kontrolü — {{guncelleme-hatasi}} var mı?' },
    ...
    diyagram:{
      ...
      adimlar:[
        { ic:'📊', rol:'Kullanıcı', baslik:'Kaynak veri hazırlanır',
          aciklama:'Excel veya CSV. ⚠️ Sayısal görünen kodlar ' +
        ...
        { ic:'🧪', rol:'Danışman', baslik:'⚠️ Küçük kümeyle deneme',
        ...
        { ic:'▶️', rol:'Danışman', baslik:'Tam yükleme — parçalara bölerek',
          aciklama:'Büyük kümeler bölünür. ⚠️ Paralel çalıştırılacaksa ' +
        ...
        { ic:'🔇', rol:'Kontrol 2', baslik:'⚠️ {{SM13}} — sessiz kayıplar',
    ...
    adimlar:[
      ...
      { rol:'Danışman', eylem:'Küçük kümeyle dener', sistem:'⚠️ **Taranarak** seçilmiş 10–50 satır' },
      { rol:'Danışman', eylem:'Tam yükleme yapar', sistem:'Parçalara bölerek' },
      { rol:'Danışman', eylem:'⭐ Mutabakat yapar', sistem:'Adet **ve** tutar' },
      { rol:'Danışman', eylem:'⚠️ Sessiz kayıp arar', sistem:'{{SM13}}' },
    ...
    notlar:[
      { tip:'warn', baslik:'⭐ "Hatalı satırlarla ne olacak?" — yöntemi belirleyen soru', metin:
        ...
        '**{{bapi}}** ⚠️ Program **ne yaparsa o olur**. ' +
  ...
  muhasebe: {
    ...
    etkilenenHesaplar:[
      ...
      { hesap:'⚠️ Mükerrer kayıt', tur:'Risk', neden:'Yeniden çalıştırma korumasız ise **çift** yazılır.' },
      { hesap:'⚠️ Eksik kayıt', tur:'Risk', neden:'{{guncelleme-hatasi}} — sessizce kaybolur.' },
    ...
    fisler:[
      ...
      { baslik:'② ⚠️ Mükerrer kayıt — yeniden çalıştırma koruması yoksa',
        belgeTuru:'SA', tarih:'15.01.2028', paraBirimi:'TRY',
        satirlar:[
        ...
        not:'⚠️ **Program yarıda kesildi ve baştan çalıştırıldı.** ' +
      ...
      { baslik:'③ ⚠️ Eksik kayıt — {{guncelleme-hatasi}}',
        belgeTuru:'SA', tarih:'15.01.2028', paraBirimi:'TRY',
        satirlar:[
          { hesap:'770', ad:'Genel yönetim gideri — **486 satır**', borc:11907000 },
          { hesap:'399', ad:'Geçiş hesabı', alacak:11907000 },
        ],
        not:'⚠️ **500 satır gönderildi, 486’sı oluştu. 14’ü sessizce kayboldu.**\n\n' +
    ...
    tHesaplar:[
      { hesap:'⭐ Geçiş hesabı — üç senaryo', kod:'399',
        ...
        not:'⚠️ **343.000 fark** = 14 eksik satır. Sıfır değil → yükleme eksik' },
    ],
    ...
    notlar:[
      { tip:'warn', baslik:'Çok satırlı belgede LUW bütünlüğü', metin:
        ...
        '⚠️ **Yanlış:** her satır ayrı işlemde — ' +
  ...
  cesitler: {
    anlatim:
      ...
      'BAPI seçilecekse → ⚠️ **{{arayuz-tablosu}} deseni kurgulanmalı**',
    ...
    liste:[
      ...
      { ad:'📨 Yöntem · {{idoc}}', en:'IDoc',
        ...
        ornek:'⭐ **En iyi izlenebilirlik.** Her IDoc:\n' +
              ...
              '⚠️ **En sık hata:** partner profili yoksa IDoc ' +
      ...
      { ad:'🗃️ Desen · {{arayuz-tablosu}} — BAPI için zorunlu', en:'Staging Table',
    ...
    karsilastirma:[
      ...
      ['Ekran değişikliği', '⚠️ **Bozulur**', '✅ Etkilenmez', '✅ Etkilenmez'],
      ['Doğrulamalar', '✅ Ekran doğrulamaları', '✅ **İş mantığı**', '✅ İş mantığı'],
      ['Hata mesajı', 'Ekran diliyle', '✅ **Yapılandırılmış**', '✅ Statü + metin'],
      ['⭐ Hatalı satırlar', '✅ **Oturumda bekler**', '⚠️ **Senin kurgun**', '✅ Sistemde kalır'],
      ['⭐ Tekrar çalıştırma', '✅ **Hazır gelir**', '⚠️ {{arayuz-tablosu}} gerekir', '✅ {{BD87}}'],
      ['Mükerrer riski', '✅ Yok', '⚠️ **Var** — korumasızsa', '✅ Yok'],
      ['Kurulum yükü', 'Orta', 'Program yazımı', '⚠️ **Ağır** — {{WE20}}'],
    ...
    liste:[
      { kod:'SM35', ad:'Toplu giriş kuyruğu — hatalılar burada bekler',
        ...
        hatalar:[
          ...
          { mesaj:'Oturum kayboldu', sebep:'Başarılı oturumlar ayara göre **silinir**.', cozum:'⚠️ Geçiş projelerinde saklama açık olmalı — **denetim izi**.' },
        ...
        ipucu:'⭐ **{{toplu-giris}}’in en değerli özelliği: hatalı satırlar kaybolmaz.**\n\n' +
              ...
              '⚠️ Ama yeterli değildir: {{guncelleme-hatasi}} oturumda ' +
      ...
      { kod:'SM13', ad:'Güncelleme hataları — sessiz kayıpların adresi',
        ...
        adimlar:[
          ...
          { baslik:'⚠️ Kaç satır etkilendi — **kapsamı ölç**' },
        ],
        ekranAkisi:[
          { ekran:'Yükleme', islem:'500 satır gönderildi · ekran *"tamamlandı"*' },
          { ekran:'Mutabakat', islem:'⚠️ {{BKPF}}’te **486** belge — 14 eksik' },
        ...
        ipucu:'⚠️ **Bu adım toplu yüklemede zorunludur** çünkü ' +
      ...
      { kod:'WE02', ad:'IDoc listesi — statü bazlı izleme',
        ...
        ekranAkisi:[
          ...
          { ekran:'{{WE02}}', islem:'340 IDoc · **312 statü 53** ✓ · **28 statü 51** ⚠️' },
        ...
        hatalar:[
          { mesaj:'IDoc geldi ama işlenmedi — **statü 56**', sebep:'⚠️ Partner profili yok.', cozum:'{{WE20}}’de partner ve mesaj tipi tanımlanır. **En sık IDoc hatası.**' },
        ...
        ipucu:'⭐ **IDoc’un en büyük avantajı: hiçbir mesaj kaybolmaz.**\n\n' +
              ...
              '⚠️ Bedeli kurulum yüküdür — tek seferlik yükleme için **fazla ağır**.',
      ...
      { kod:'SE37', ad:'BAPI testi — commit tuzağı burada görülür',
        ...
        hatalar:[
          { mesaj:'BAPI başarılı ama kayıt yok', sebep:'⚠️ Commit çağrılmamış.', cozum:'`BAPI_TRANSACTION_COMMIT` eklenir. **BAPI’nin en sık atlanan kuralı.**' },
        ...
        ipucu:'⚠️ **Commit tuzağı BAPI’nin en pahalı sürprizidir** ' +
  ...
  tablolar: {
    ...
    liste:[
      ...
      { ad:'LFA1', baslik:'Tipik hedef — ana veri',
        ...
        anahtar:'LIFNR',
        iliskiler:'⚠️ Şirket kodu verisi {{LFB1}}’de — **ayrı yükleme**.',
        s4:'{{BP}} ile yönetilir.',
        alanlar:[
  ...
  sapSurec: {
    ...
    ekranlar:[
      ...
      { ad:'{{SM13}} — sessiz kayıplar',
        ...
        ipucu:'⚠️ **Tek kayıtta nadir, toplu yüklemede sıktır** — ' +
    ...
    hatalar:[
      ...
      { mesaj:'BAPI başarılı döndü, belge yok', sebep:'⚠️ `BAPI_TRANSACTION_COMMIT` çağrılmamış.', cozum:'Commit eklenir. Sessiz olduğu için **mutabakat olmadan fark edilmez**.' },
      { mesaj:'Aynı kayıt iki kez oluştu', sebep:'⚠️ Program yeniden çalıştırılmış, koruma yok.', cozum:'{{arayuz-tablosu}} deseni veya `XBLNR` üzerinden mükerrer kontrolü. {{toplu-giris}}’te bu sorun **yoktur**.' },
      ...
      { mesaj:'Paralel yüklemede kilit hataları', sebep:'{{kilitleme}} — aynı ana veriye iki oturum.', cozum:'⚠️ Parçaları **aynı nesneye dokunmayacak** şekilde böl.' },
      { mesaj:'Belge yarım oluşmuş', sebep:'Satır bazlı işlem — LUW bütünlüğü yok.', cozum:'⚠️ Çok satırlı belgede **belge bazlı** işlem: tamamı veya hiçbiri.' },
    ...
    ipuclari:[
      ...
      'Adet tutup tutar tutmuyorsa {{donusum-kurali}} hatası.',
      '⚠️ Toplu yükleme sonrası **{{SM13}} zorunlu** — sessiz kayıplar orada.',
  ...
  teknik: {
    ...
    commit:
      ...
      '━━━━━━━━━━\n\n' +
      '⚠️ **Commit sıklığı bir denge kararıdır:**\n\n' +
      '**Her kayıtta commit** → yavaş ama **güvenli**; hata tek kaydı etkiler\n' +
      '**Toplu commit (her 1000’de)** → hızlı ama ⚠️ **çökerse 1000 kayıt gider**\n\n' +
      'Veri geçişinde genelde **güvenlik tercih edilir** — ' +
      'bir kez çalışacak bir iş için hız ikincildir.',

    belgeNo:
      '⚠️ **Numara diyalog aşamasında verilir, kayıt güncelleme görevinde yazılır.**\n\n' +
    ...
    postingLogic:
      ...
      '**7.** Hesap belirleme · **8.** Numara · **9.** ⚠️ **Güncelleme (asenkron)**\n\n' +
      '⭐ **İki önemli sonuç:**\n\n' +
      ...
      '⚠️ **İstisna:** {{GGB4}} etkinlik seviyesi **2** ise kural ' +
    ...
    numberRange:
      ...
      '⚠️ Aralık dolduğunda yükleme **ortasında** durur ve ' +
    ...
    tur:
      ...
      '⚠️ **commit ve tekrar çalıştırma senin işin**.\n\n' +
      '**{{idoc}}** — mesaj. ' +
    ...
    transport:
      ...
      '⚠️ **Ama taşınmayan üç şey vardır:**\n\n' +
      ...
      '**3. ⚠️ {{WE20}} partner profilleri** — sistem bazlı ayarlardır ve ' +
      'genelde **elle** kurulur; taşıma sonrası IDoc’lar ' +
      '**statü 56** ile reddedilirse ilk bakılacak yer burasıdır.',

    img:[
      { yol:'WE20 → Partner profilleri', not:'⚠️ IDoc statü 56’nın kaynağı; sistem bazlı' },
      { yol:'SM35 → Toplu giriş → Saklama ayarı', not:'⭐ Geçiş projelerinde oturumlar **saklanmalı**' },
      { yol:'FBN1 → Numara aralığı', not:'⚠️ Toplu yükleme aralığı **hızla tüketir**' },
      { yol:'GGB4 → Doğrulama etkinlik seviyesi', not:'⚠️ Seviye 2 = **toplu giriş hariç**' },
    ],
    ...
    notlar:[
      { tip:'warn', baslik:'⭐ Sayı mutabakatı — tek zorunlu kural', metin:
        ...
        'kur, birim, işaret\n\n' +
        '⚠️ **Adet tutup tutar tutmuyorsa** dönüşüm hatası vardır. ' +
  ...
  s4hana: {
    ozet:
      ...
      '⚠️ bazı hedef tablolar **görünüme dönüştü** ve doğrudan yazılamıyor.',

    eccFarklari:[
      { konu:'{{toplu-giris}}', ecc:'Yaygın', s4:'⚠️ **Çalışır** ama {{BP}} gibi işlemlerde güvenilmez' },
      ...
      { konu:'Hedef tablolar', ecc:'{{BSEG}}, {{BSIK}} yazılabilir', s4:'⚠️ İndeksler **görünüm** — yazılamaz' },
      { konu:'Simülasyon', ecc:'Yok', s4:'⭐ **Yükleme öncesi** doğrulama' },
      { konu:'Şablon', ecc:'Kendin tanımlarsın', s4:'⭐ Hazır, **önceden eşli** Excel' },
      { konu:'Bulut', ecc:'—', s4:'⚠️ Cloud’da **yalnızca** Migration Cockpit / API' },
    ],
    ...
    universalJournal:
      ...
      '⚠️ **Ama {{ACDOCA}}’ya doğrudan yazılmaz** — ' +
    ...
    kalkanTcodes:[
      ...
      { eski:'{{BSIK}} / {{BSID}}’e yazma', yeni:'**Mümkün değil**', not:'⚠️ Görünüme dönüştü — belge kaydı üzerinden' },
      { eski:'{{XK01}} recording', yeni:'{{BP}} nesnesi', not:'⚠️ BP ekran akışı recording için **fazla karmaşık**' },
    ...
    compatibilityViews:[
      '⚠️ {{BSIK}}, {{BSID}}, {{BSAS}} artık **görünümdür** — **yazılamaz**.',
    ...
    performans:
      ...
      '⚠️ **Ama parçalar dikkatli seçilmelidir:** aynı ana veriye ' +
    ...
    bestPractices:[
      ...
      '⚠️ Eski yükleme programlarını taşırken **hedef tablo yazılabilir mi** kontrol et.',
  ...
  senaryo: {
    ...
    veriler:[
      ...
      { k:'Oluşan belge', v:'⚠️ **8.060**' },
      { k:'Kayıp', v:'⚠️ **340 kayıt · 1.284.000 TRY**' },
    ...
    adimlar:[
      { baslik:'Gerçekten kaç belge oluştu?', tcode:'SE16N',
        ...
        girdi:[
          ...
          { alan:'Fark', deger:'⚠️ **340** — ve tutar farkıyla **tutarlı**' },
        ],
        not:'⭐ **Bu sayım yükleme günü yapılsaydı sorun 3 gün değil ' +
             ...
             '⚠️ Ama o mesaj **programın çalıştığını** söyler, ' +
      ...
      { baslik:'340 kayıt nereye gitti?', tcode:'SM13',
        ...
        girdi:[
          ...
          { alan:'Sonuç', deger:'⚠️ **340 güncelleme hatası**' },
        ...
        not:'**{{guncelleme-hatasi}}.** Numara verilmiş, belge **yazılmamış**.\n\n' +
             ...
             '⚠️ Çünkü hata BAPI aşamasında değil, ' +
      ...
      { baslik:'Kilit çakışması neden oluştu?', tcode:'SM37',
        ...
        girdi:[
          { alan:'Çalıştırma', deger:'⚠️ **6 paralel iş** — hızlandırmak için' },
          { alan:'Bölme', deger:'Kaynak dosya **satır numarasına** göre bölünmüş' },
          { alan:'Sonuç', deger:'⚠️ Aynı satıcı **birden çok parçada**' },
        ...
        not:'⭐ **Kök sebep bulundu — ve bir hızlandırma kararıydı.**\n\n' +
             ...
             '⚠️ **Doğru bölme ölçütü satır numarası değil, ' +
      ...
      { baslik:'Program neden hatayı yakalamadı?', tcode:'SE37',
        ...
        girdi:[
          ...
          { alan:'Eksik', deger:'⚠️ Commit **sonrası** doğrulama **yok**' },
          { alan:'{{arayuz-tablosu}}', deger:'⚠️ **Kullanılmamış** — ham dosyadan okunuyor' },
      ...
      { baslik:'Düzeltme — eksik 340 kayıt', tcode:'SE16N',
        ...
        girdi:[
          ...
          { alan:'② Karar', deger:'⚠️ Baştan çalıştırma **yok** — 8.060 mükerrer olurdu' },
        ...
        not:'⚠️ **Baştan çalıştırma seçeneği yoktu.** ' +
      ...
      { baslik:'Kalıcı önlemler', tcode:'SM13',
        ...
        girdi:[
          ...
          { alan:'③ Paralel bölme', deger:'⚠️ Satır numarasına göre **değil**, **kilitlenen nesneye** göre' },
  ...
  ogrenme: {
    ozet:[
      ...
      '**{{bapi}}** → hızlı ve temiz ama ⚠️ tekrar çalıştırma **senin kurgun** — ' +
      '{{arayuz-tablosu}} deseni gerekir.',
      '**{{idoc}}** → **hiçbir mesaj kaybolmaz**, kurulum ağır — sürekli arayüz için.',
      '⚠️ BAPI’de `BAPI_TRANSACTION_COMMIT` yoksa kayıt **yazılmaz**, ' +
      'BAPI yine *"başarılı"* döner.',
      '⭐ **{{sayi-mutabakati}} — tek zorunlu kural.** Adet **ve** tutar.',
      '⚠️ Toplu yükleme sonrası **{{SM13}}** — {{guncelleme-hatasi}} orada.',
      '⚠️ Paralel bölme ölçütü **kilitlenen nesne**, satır numarası değil.',
    ],

    onemliNoktalar:[
      '**"Batch input mi BAPI mi kullanırsın?"** ⭐ Cevap hızla başlamaz. Belirleyici soru: **"hatalı satırlarla ne olacak?"** {{toplu-giris}} → hatalılar {{SM35}} oturumunda **bekler**, düzeltilip yeniden işlenir, başarılılar **tekrarlanmaz** — tekrar çalıştırılabilirlik **hazır gelir**. {{bapi}} → hızlı, ekrandan bağımsız, hata mesajı yapılandırılmış; ⚠️ ama tekrar çalıştırma **senin kurgun** — {{arayuz-tablosu}} deseni gerekir.',
      '**"BAPI başarılı döndü ama kayıt yok. İki olası sebep?"** **(1)** `BAPI_TRANSACTION_COMMIT` çağrılmamış — BAPI *"başarılı"* döner, belge numarası verir, veritabanında hiçbir şey yoktur. **(2)** ⚠️ {{guncelleme-hatasi}} — hata BAPI aşamasında değil **asenkron güncelleme** aşamasında oluşmuş ve `RETURN` tablosuna **yansımamış**. İkincisi için {{SM13}} **ayrı** kontrol edilir.',
      ...
      '**"IDoc ne zaman tercih edilir?"** ⭐ **Sürekli** veri akışı ve dış sistem entegrasyonunda. En büyük avantajı: **hiçbir mesaj kaybolmaz** — her IDoc kendi statüsünü ve hata sebebini taşır, {{BD87}} ile tek tek yeniden işlenir, arşivlenir. ⚠️ Bedeli kurulum yüküdür ({{WE20}} partner profili, mesaj tipi, port) — tek seferlik 3.000 satır için **fazla ağır**. ⚠️ En sık hata: partner profili yoksa **statü 56**.',
      ...
      '**"S/4HANA\'da yükleme yöntemlerinde ne değişti?"** Yöntemlerin hepsi **çalışıyor**. Değişenler: **(1)** Migration Cockpit ({{LTMC}}) öne çıktı — hazır şablon ve ⭐ **yükleme öncesi simülasyon**. **(2)** ⚠️ {{BSIK}}/{{BSID}} **görünüme dönüştü**, doğrudan **yazılamaz** — bu tablolara yazan eski programlar çalışmaz; açık kalem **belge kaydıyla** oluşturulur. **(3)** {{BP}} için recording güvenilmez. **(4)** Cloud’da {{toplu-giris}} yok — **API / Cockpit**.',
    ],
    ...
    sikHatalar:[
      ...
      { hata:'{{SM13}} kontrolünü atlamak.', dogru:'⚠️ {{guncelleme-hatasi}} toplu yüklemede **sıktır** — paralel görevler kilit çakışması yaratır.' },
      { hata:'BAPI `RETURN` tablosunu yeterli saymak.', dogru:'⚠️ Güncelleme hatası **RETURN’e yansımaz** — sonradan oluşur.' },
      ...
      { hata:'Hata sonrası programı baştan çalıştırmak.', dogru:'⚠️ Koruma yoksa başarılılar **çift** yazılır. Önce hangi satırların işlendiği tespit edilir.' },
      { hata:'Paralel yüklemeyi satır numarasına göre bölmek.', dogru:'⚠️ **Kilitlenen nesneye** göre bölünür — yoksa çakışma ve **sessiz kayıp**.' },
      { hata:'Çok satırlı belgeyi satır bazlı yüklemek.', dogru:'Belge **yarım kalır**. Belge bazlı işlem: tamamı veya hiçbiri.' },
      { hata:'S/4HANA’da {{BSIK}}’e yazmaya çalışmak.', dogru:'⚠️ **Görünümdür**, yazılamaz. Açık kalem **belge kaydıyla** oluşur.' },
    ...
    ipuclari:[
      ...
      '⚠️ Toplu yükleme sonrası **{{SM13}}** — ayrı ve zorunlu adım.',
    ...
    quiz:[
      ...
      { soru:'BAPI "başarılı" döndü ama belge yok. İki olası sebep nedir?',
        ...
        aciklama:'**Sebep 1 — Commit yok.** `BAPI_TRANSACTION_COMMIT` ' +
                 ...
                 've belge numarası verir. ⚠️ **Sessiz** hatadır.\n\n' +
      ...
      { soru:'{{sayi-mutabakati}}’nda adet tutuyor ama tutar tutmuyor. Ne anlama gelir?',
        ...
        aciklama:'⭐ **İki seviyeli mutabakatın değeri tam olarak budur.**\n\n' +
                 ...
                 '• Birim çevrimi\n' +
                 '• İşaret (borç/alacak)\n\n' +
                 '⚠️ Yalnızca adet sayan bir kontrol bu hata sınıfını ' +
      ...
      { soru:'Sürekli çalışacak bir arayüz için hangi yöntem tercih edilir?',
        ...
        aciklama:'⭐ **IDoc’un en büyük avantajı: hiçbir mesaj kaybolmaz.**\n\n' +
                 ...
                 '⚠️ Bedeli kurulum yüküdür: {{WE20}} partner profili, ' +
                 'mesaj tipi, port tanımı. Tek seferlik 3.000 satırlık ' +
                 'bir yükleme için **fazla ağırdır**.\n\n' +
                 '⚠️ En sık hata: partner profili yoksa IDoc **statü 56** ' +
      ...
      { soru:'S/4HANA’da eski bir yükleme programı çalışmıyor. En olası sebep?',
        ...
        aciklama:'⚠️ {{BSIK}}, {{BSID}}, {{BSAS}} gibi indeks tabloları ' +
