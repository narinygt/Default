...
SAP.registerTopic({
  ...
  tanim: {
    ...
    gercekHayat:
      ...
      '**3.** *"Ama mevcut özel raporlarınızın bir kısmı **uyarlanmazsa ' +
    ...
    muhasebeMantigi:
      ...
      '**Ama bir şey değişti ve önemlidir:** {{BSEG}}’de tutarlar ' +
  ...
  surec: {
    ...
    roller:[
      ...
      { rol:'Sistem', gorev:'Toplam tablolarını **yazmaz** — artık yoklar.' },
      { rol:'Sistem', gorev:'İndeks tablolarını **yazmaz** — artık görünümler.' },
      ...
      adimlar:[
        ...
        { ic:'⭐', rol:'Sistem', baslik:'{{ACDOCA}} — **tek kalem tablosu**',
          aciklama:'FI kalemleri, CO nesneleri, varlık boyutu, defter, segment, ' +
                   ...
                   'hepsi **aynı satırda**.\n\n' +
                   'Tutarlar **işaretlidir**: alacak negatif.',
        ...
        { ic:'🚫', rol:'ECC’de vardı', baslik:'{{GLT0}} / {{FAGLFLEXT}} — toplam tabloları',
          aciklama:'Hesap ve dönem bazında bakiyeler **önceden hesaplanıp** saklanırdı.\n\n' +
                   'İki dezavantajı vardı: yer kaplarlar ve ' +
        ...
        { ic:'⚠️', rol:'Özel kod', baslik:'{{z-gelistirme}} eski tabloyu okuyorsa',
          aciklama:'{{uyumluluk-view}} devreye girer: sorgu çalışır ama ' +
                   ...
                   '**Ücretsiz değildir** ve `SHKZG` semantiği ' +
    ...
    adimlar:[
      ...
      { rol:'Sistem', eylem:'Toplam yazmaz', sistem:'{{GLT0}} / {{FAGLFLEXT}} yok' },
      { rol:'Sistem', eylem:'İndeks yazmaz', sistem:'{{BSIK}} / {{BSID}} görünüm' },
    ...
    notlar:[
      { tip:'tip', baslik:'Bir mimari ders: kısıt kalkınca çözüm gereksizleşir', metin:
        ...
        'Ama kaldırma **bedava değildir**: eski yapıya bağlı her şeyin ' +
    ...
    fisler:[
      { baslik:'① Satıcı faturası — **aynı fiş, daha az tablo**',
        ...
        not:'**ECC’de bu fiş altı tabloya yazardı:**\n\n' +
             ...
             '**Kritik ayrıntı:** `320` satırının tutarı {{ACDOCA}}’da ' +
      ...
      { baslik:'④ Aynı varlık, **IFRS defteri (2L)** — gerçek zamanlı',
        ...
        not:'**Yeni Varlık Muhasebesi’nin asıl değişikliği burada.**\n\n' +
             ...
             'Ama dikkat: aynı varlık iki defterde **farklı bakiye** taşır ' +
  ...
  cesitler: {
    ...
    liste:[
      ...
      { ad:'Öbek 1 · {{evrensel-kayit-defteri}} ({{ACDOCA}})', en:'Universal Journal',
        ...
        ornek:'**Ne birleşti:** {{BSEG}} (FI kalemleri) · `COEP` (CO satırları) · ' +
              ...
              'Tutarlar **işaretlidir** — {{BSEG}}’den farklı.',
      ...
      { ad:'Öbek 1 · Kalkan indeks tabloları', en:'Removed Index Tables',
        ...
        ornek:'**Açık kalemler:** {{BSIK}} (satıcı) · {{BSID}} (müşteri) · {{BSIS}} (G/L)\n' +
              ...
              '**Okunur ama YAZILAMAZ.** Eski yükleme programları ' +
      ...
      { ad:'Öbek 2 · {{is-ortagi}} zorunluluğu', en:'Business Partner',
        ...
        ornek:'**Sorun neydi:** aynı firma hem satıcı hem müşteriyse ' +
              ...
              '**Yanlış anlaşılan nokta:** şirket kodu verisi **kaybolmadı** — ' +
              'hâlâ {{LFB1}} / {{KNB1}}’de durur ve `AKONT` ' +
              '{{mutabakat-hesabi}} oradadır. Değişen **kimlik katmanıdır**.\n\n' +
              '{{brownfield}} geçişte {{cvi}} dönüşümü **ön koşuldur** ' +
      ...
      { ad:'Öbek 2 · Masraf türü = G/L hesabı', en:'Cost Element in G/L',
        ...
        ornek:'ECC: {{SKA1}} (G/L) + {{CSKB}} (masraf türü) → **iki nesne, iki adım**\n' +
              ...
              '**Sahiplik sorusu doğar:** hesap planı muhasebenin, ' +
              'masraf türleri kontrolörlüğün alanıydı. Artık tek liste var — ' +
              'kimin sahip olduğu **açıkça kararlaştırılmalıdır**.\n\n' +
              'Brownfield geçişte eşleşmeyen masraf türleri ' +
              'dönüşümü **durdurur**.',
        tcodes:['FS00'] },
      ...
      { ad:'Öbek 4 · {{merkezi-finans}}', en:'Central Finance',
        ...
        ornek:'Kaynak sistemler (SAP veya SAP dışı) çalışmaya devam eder; ' +
              ...
              'Bir geçiş değil bir **köprüdür**: eşleme (hesap planı, ' +
    ...
    karsilastirma:[
      ...
      ['FI–CO ayrışması', 'Mümkün — mutabakat gerekir', '✓ **Yapısal olarak imkânsız**'],
      ['G/L bakiyeleri', '{{GLT0}} / {{FAGLFLEXT}} **saklanır**', '**Hesaplanır**'],
      ['Açık kalemler', '{{BSIK}} / {{BSID}} fiziksel tablo', '{{uyumluluk-view}} — **yazılamaz**'],
      ['Tutar işareti', 'Hep pozitif + `SHKZG`', '**İşaretli** (alacak negatif)'],
      ['Satıcı / müşteri', '{{LFA1}} / {{KNA1}} bağımsız', '**{{is-ortagi}} zorunlu**'],
    ...
    liste:[
      { kod:'SE16N', ad:'Tablo görüntüleme — S/4 gözüyle',
        ...
        adimlar:[
          ...
          { baslik:'Karşılaştır: aynı kalem iki yerde **farklı işaretle**',
        ...
        ekranAkisi:[
          ...
          { ekran:'Çıkarım', islem:'**Aynı kalem, iki farklı gösterim** — sorgu mantığı buna göre yazılmalı' },
        ...
        hatalar:[
          { mesaj:'{{BSIK}}’e yazmaya çalışan program hata veriyor', sebep:'Artık **görünüm** — yazılamaz.', cozum:'Açık kalem **belge kaydıyla** oluşturulur; program uyarlanır.' },
        ...
        ipucu:'**{{SE16N}} kullanıcıya verilmez** — yetki kontrolü zayıftır ve ' +
      ...
      { kod:'SAT', ad:'Çalışma zamanı analizi',
        ...
        hatalar:[
          ...
          { mesaj:'Sürenin çoğu ABAP tarafında', sebep:'Döngü içinde tek tek okuma.', cozum:'Toplu okuma. Görünüm üzerinden döngüsel okuma, S/4’te ECC’dekinden **çok daha pahalıdır**.' },
        ],
      ...
      { kod:'FINSC_LEDGER', ad:'Defter tanımları',
        ...
        adimlar:[
          ...
          { baslik:'Defter yapısı bir {{tek-yonlu-kapi}}dır',
        ...
        hatalar:[
          ...
          { mesaj:'Yeni defter açtık ama geçmiş yok', sebep:'**Beklenen davranış** — defter yapısı tek yönlü kapıdır.', cozum:'Geçmiş yazılamaz. Bu yüzden defterler **baştan** açılır; kullanılmayan defter maliyetsizdir.' },
        ],
  ...
  tablolar: {
    ...
    liste:[
      { ad:'ACDOCA', baslik:'Evrensel Kayıt Defteri — tek satır kaynağı',
        ...
        alanlar:[
          ...
          { ad:'HSL', aciklama:'Yerel para birimi tutarı — **İŞARETLİ**, alacak negatif' },
      ...
      { ad:'GLT0', baslik:'Kalkan toplam tablosu — neden vardı, neden gitti',
        ...
        s4:'**{{uyumluluk-view}}** — okunur, yazılmaz. Bakiye {{ACDOCA}}’dan hesaplanır.',
        alanlar:[
      ...
      { ad:'BSIK', baslik:'Kalkan indeks tablosu — anahtar meselesi',
        ...
        s4:'**Görünüm** — okunur, **yazılamaz**.',
        alanlar:[
          { ad:'LIFNR', aciklama:'**Anahtarın ilk parçası** — varlık sebebi buydu: {{BSEG}} belge numarasıyla başlar' },
          { ad:'SHKZG', aciklama:'Borç/alacak — tutar **pozitif**, yön burada. {{ACDOCA}}’da öyle değil' },
      ...
      { ad:'BUT000', baslik:'İş Ortağı — yeni kimlik katmanı',
        ...
        alanlar:[
          ...
          { ad:'Not', aciklama:'`AKONT` **burada değil** — {{LFB1}}’de. Kimlik katmanı ile şirket kodu verisi ayrı' },
        ] },
    ...
    er:{
      ...
      varliklar:[
        ...
        { ad:'BSIK', rol:'Görünüm', aciklama:'**Yazılamaz** — {{ACDOCA}}’dan üretilir',
          alanlar:[{ ad:'LIFNR', tip:'fk' }, { ad:'SHKZG' }] },
        { ad:'GLT0', rol:'Görünüm', aciklama:'Toplam **hesaplanır**, saklanmaz',
      ...
      iliskiler:[
        ...
        { from:'ACDOCA', to:'BSIK', alanlar:'—', not:'görünüm **buradan üretilir**' },
        { from:'ACDOCA', to:'GLT0', alanlar:'—', not:'toplam **hesaplanır**' },
  ...
  sapSurec: {
    ...
    ekranlar:[
      { ad:'{{BP}} — İş Ortağı',
        ...
        alanlar:[
          ...
          { ad:'Şirket kodu verisi', zorunlu:true, aciklama:'Hâlâ ayrı bir katman — ' +
                   '`AKONT` {{mutabakat-hesabi}} burada.' },
          { ad:'Numaralandırma', zorunlu:true, aciklama:'İş ortağı numarası satıcı ' +
                   'numarasıyla **aynı olmak zorunda değil** — strateji baştan seçilir.' },
        ],
        ipucu:'{{XK01}}/{{XD01}} hâlâ çalışır ama arka planda {{cvi}} üzerinden ' +
      ...
      { ad:'{{FINSC_LEDGER}} — defter ve para birimi',
        ...
        ipucu:'Defter yapısı bir {{tek-yonlu-kapi}}dır — ' +
    ...
    hatalar:[
      { mesaj:'Program {{BSIK}}’e yazamıyor', sebep:'Artık **görünüm**.', cozum:'Açık kalem **belge kaydıyla** oluşur; yükleme programı uyarlanır.' },
      { mesaj:'Taşınan rapor yanlış toplam veriyor (sıfıra yakın)', sebep:'`SHKZG` mantığı **iki kez** uygulanmış — {{ACDOCA}} tutarı zaten işaretli.', cozum:'Sorgudan yön mantığı **kaldırılır**. Bu hata **sessizdir**: program çökmez, yanlış sayı üretir.' },
      ...
      { mesaj:'Yeni para birimi ekledik ama geçmişte boş', sebep:'Beklenen davranış.', cozum:'Geriye dönük doldurulmaz. Para birimi slotları **baştan** açılır.' },
    ],

    ipuclari:[
      'Tezi hatırla: **"toplamı saklamak yerine hesapla"** — geri kalanı sonuçtur.',
      '{{ACDOCA}}’da tutarlar **işaretlidir**; taşınan sorgudan `SHKZG` mantığını **kaldır**.',
      ...
      '"S/4HANA hızlı" cümlesi **kod uyarlandığı ölçüde** doğrudur.',
    ],
  },
  ...
  teknik: {
    guncellenenTablolar:[
      ...
      { tablo:'BSIK', ne:'Artık **görünüm** — yazılmaz' },
      { tablo:'GLT0', ne:'Artık **görünüm** — toplam hesaplanır' },
    ...
    commit:
      ...
      'Ama {{SM13}} kontrolü **hâlâ gereklidir** — güncelleme hatası ' +
    ...
    belgeNo:
      ...
      'Eski `BUZEI` sınırına takılan özel programlar bu farkı ' +
      'hesaba katmalıdır.',
    ...
    accountDetermination:
      ...
      '{{brownfield}} geçişte bu bir hazırlık adımıdır: ' +
      'eşleşmeyen masraf türleri dönüşümü **durdurur**.',
    ...
    ekstra:[
      ...
      { ic:'🌉', baslik:'Uyumluluk view’i bir köprüdür, bir çözüm değil', metin:
        ...
        'Tek seferlik sorguda fark edilmez. Ama bir **döngü içinde** ' +
  ...
  s4hana: {
    ...
    eccFarklari:[
      ...
      { konu:'Yapılandırma erişimi', ecc:'Tam {{SPRO}}', s4:'Genel bulutta **kısıtlı** — rehberli yapılandırma' },
      { konu:'{{z-gelistirme}}', ecc:'Serbest', s4:'Genel bulutta **yalnızca genişletme** — modifikasyon yok' },
      ...
      { konu:'Türkiye yerelleştirmesi', ecc:'Add-on ve özel geliştirme yaygın', s4:'Bulutta add-on **kısıtlı** — {{konu:e-donusum}} planlanmalı' },
    ...
    kalkanTcodes:[
      ...
      { eski:'{{XK01}} / {{XD01}} (tek yol olarak)', yeni:'**{{BP}}**', not:'Eskiler çalışır ama tek doğru yol BP' },
    ...
    compatibilityViews:[
      ...
      'Genel bulutta {{SE16N}} ile ham tablo erişimi de **kısıtlıdır** — ' +
    ...
    performans:
      '**Bu konudaki en yaygın yanılgı:** *"S/4HANA hızlı, ' +
      ...
      '**3. Özel programlar** — **uyarlanmazsa yavaşlayabilir**. ' +
  ...
  senaryo: {
    ...
    adimlar:[
      { baslik:'Zaman nerede harcanıyor?', tcode:'SM37',
        ...
        girdi:[
          ...
          { alan:'En uzun 3 iş', deger:'Sürenin **%71’i**' },
        ...
        not:'**İlk bulgu tezi doğruluyor.**\n\n' +
             ...
             'Yavaşlayan yalnızca **özel programlardı** ve ' +
      ...
      { baslik:'Bu üç program ne yapıyor?', tcode:'SAT',
        ...
        girdi:[
          { alan:'Sürenin dağılımı', deger:'**%86 veritabanında**' },
        ...
        not:'**Sorun bulundu.**\n\n' +
             ...
             'S/4HANA’da aynı isim bir **görünümdür** ve her çağrıda ' +
             '{{ACDOCA}}’dan **hesaplanır**.\n\n' +
             'Üstelik üç program da bunu **döngü içinde** yapıyordu — ' +
      ...
      { baslik:'Programları taşırken bir şey daha çıktı', tcode:'SE16N',
        ...
        girdi:[
          ...
          { alan:'Eski sürüm sonucu', deger:'Toplam borç **1.340.000**' },
          { alan:'{{FS10N}} mizanı', deger:'84.200.000 ✓' },
          { alan:'Çıkarım', deger:'**Eski rapor sekiz aydır yanlış**' },
        ],
        not:'**Asıl bulgu burada — ve aranmıyordu.**\n\n' +
      ...
      { baslik:'Ne yapıldı?', tcode:'FAGLL03',
        ...
        girdi:[
          ...
          { alan:'2. adım', deger:'**214 programın tamamı** tarandı' },
          { alan:'`SHKZG` kullanan', deger:'**31 program**' },
          { alan:'Yanlış sonuç veren', deger:'**9 program**' },
        ...
        not:'Kapanış beklenenden de iyi geldi: **3 günden 2 güne**. ' +
             ...
             'Ama asıl kazanç bu değildi: tarama **dokuz yanlış rapor** buldu. ' +
    ...
    sonuc:
      ...
      '**Ve ikinci fark sessizdir** — birincisi şikâyet üretir, ' +
      'ikincisi üretmez.\n\n' +
  ...
  ogrenme: {
    ozet:[
      ...
      '**{{ACDOCA}}’da tutarlar işaretlidir** (alacak negatif); {{BSEG}}’de ' +
      ...
      '**"S/4HANA hızlı"** cümlesinin eksik yarısı: **uyarlanmış kod için**.',
    ...
    onemliNoktalar:[
      ...
      '**"Eski raporlarım çalışmaya devam eder mi?"** Evet — {{uyumluluk-view}} sayesinde. **Ama iki şey vaat edilmez:** **①** **ücretsiz değil** — ECC\'de {{BSIS}} fiziksel tabloydu, artık her çağrıda {{ACDOCA}}\'dan hesaplanıyor; döngü içinde okuyan eski ABAP kodu **yavaşlar**. **②** **birebir değil** — `SHKZG` semantiği değişti ve defter boyutu (`RLDNR`) eski sorgularda **hiç yoktu**. Görünüm bir **köprüdür**, kalıcı çözüm değil.',
      '**"BSEG ile ACDOCA arasındaki en tehlikeli fark nedir?"** **Tutarın işareti.** {{BSEG}}\'de tutarlar **hep pozitifti**, yön ayrı alandaydı (`SHKZG` = S/H). {{ACDOCA}}\'da tutarlar **işaretlidir** — alacak negatif. Taşınan sorgudan `SHKZG` mantığı **kaldırılmazsa işaret iki kez uygulanır**: alacaklar pozitife döner, borçlarla birbirlerini götürür ve toplam **sıfıra yakın** çıkar. Ve bu hata **sessizdir**: program çökmez, sorgu çalışır, sonuç makul görünür.',
      '**"İş Ortağı zorunluluğu ne değiştirdi?"** Kimlik katmanını. ECC\'de aynı firma hem satıcı hem müşteriyse **iki ayrı kayıt** açılır ve adres verileri zamanla **ayrışırdı**. Artık tek kimlik ({{BUT000}}), çok **rol**. **Yanlış anlaşılan nokta:** şirket kodu verisi **kaybolmadı** — `AKONT` {{mutabakat-hesabi}} hâlâ {{LFB1}}\'de. {{brownfield}} geçişte {{cvi}} dönüşümü **ön koşuldur** ve teknik dönüşümden **önce** yapılır.',
      '**"Masraf türü nereye gitti?"** G/L hesabıyla **birleşti**: {{masraf-turu}} artık ayrı bir nesne ({{CSKB}}) değil, G/L hesabının **hesap tipidir** ({{FS00}}\'da seçilir). Üç sonucu var: **①** masraf türü açmak = G/L hesabı açmak (iki adım tek adım) · **②** **sahiplik sorusu** — hesap planı muhasebenin, masraf türleri kontrolörlüğün alanıydı; artık tek liste var · **③** brownfield geçişte eşleşmeyen masraf türleri dönüşümü **durdurur**.',
      ...
      '**"Geçiş sonrası kapanış uzadı, neden?"** İlk soru: **"bu programlar hangi tabloyu okuyor?"** Cevap bir {{uyumluluk-view}} ise sorun bulunmuştur. Teşhis: {{SM37}} (en uzun işler) → {{SAT}} (süre nerede) → {{ST05}} (üretilen SQL). Standart işler genelde **hızlanır**; yavaşlayan özel programlardır ve süre payının çoğunu onlar tutar. Çözüm: kritik programlar {{ACDOCA}}\'ya taşınır. Ölçüm **gerçek hacimle** yapılır — küçük test verisinde uyumluluk view\'i ucuz görünür.',
    ...
    sikHatalar:[
      ...
      { hata:'"S/4HANA hızlı, raporlarım hızlanır" varsaymak.', dogru:'Cümlenin eksik yarısı: **uyarlanmış kod için**. Eski kod {{uyumluluk-view}} üzerinden **yavaşlayabilir**.' },
      { hata:'Taşınan sorguda `SHKZG` mantığını bırakmak.', dogru:'İşaret **iki kez** uygulanır, toplam sıfıra yakın çıkar — ve hata **sessizdir**.' },
      ...
      { hata:'{{is-ortagi}} gelince {{LFB1}}’in kalktığını sanmak.', dogru:'**Kalmadı, duruyor.** `AKONT` {{mutabakat-hesabi}} hâlâ orada.' },
      { hata:'Masraf türünü ayrı nesne olarak aramak.', dogru:'G/L hesabının **tipi** ({{FS00}}). Brownfield’de hazırlık gerektirir.' },
      ...
      { hata:'Para birimi veya defteri "sonra ekleriz" diye boş bırakmak.', dogru:'Sonradan eklenen **geçmişte boş kalır**. Boş slot **maliyetsizdir** — baştan aç.' },
      { hata:'{{fiori}}’yi "yeni görünümlü GUI" sanmak.', dogru:'İşlem merkezli değil **görev merkezli**; rol tasarımı artık **arayüz tasarımıdır**.' },
      { hata:'Gömülü analitiğin veri ambarının yerini aldığını sanmak.', dogru:'Almaz. Çok kaynaklı birleştirme ve uzun tarihçe hâlâ ayrı çözüm ister.' },
      { hata:'Taşınan raporu doğrulamadan kullanmaya başlamak.', dogru:'İlk çalıştırmada {{FS10N}} mizanıyla **karşılaştır** — beş dakika.' },
      { hata:'Performansı küçük test verisiyle ölçmek.', dogru:'Uyumluluk view’i küçük veride **ucuz görünür**. Ölçüm gerçek hacimde yapılır.' },
    ],
    ...
    ipuclari:[
      ...
      '{{ACDOCA}}’da `HSL` **işaretlidir** — {{SE16N}}’de gözle doğrula.',
      'Taşınan her sorgudan `SHKZG` mantığını **kaldır**.',
    ...
    quiz:[
      ...
      { soru:'ECC’den taşınan bir rapor S/4HANA’da sıfıra yakın toplamlar veriyor. En olası sebep?',
        ...
        aciklama:'**Konunun en pahalı ayrıntısı.**\n\n' +
                 ...
                 'Eski mantık silinmezse işaret **iki kez** uygulanır: ' +
      ...
      { soru:'Uyumluluk view’leri (compatibility views) hakkında hangisi doğrudur?',
        ...
        aciklama:'{{uyumluluk-view}}ler geçişi **mümkün kılan** şeydir: ' +
                 ...
                 'Ayrıca **yazılamazlar** — açık kalem artık ' +
      ...
      { soru:'S/4HANA’da İş Ortağı zorunlu oldu. LFB1 tablosuna ne oldu?',
        ...
        aciklama:'**Bu en sık yanlış bilinen noktadır.**\n\n' +
                 ...
                 'İkinci adım atlanırsa satıcı açılır ama ' +
      ...
      { soru:'Yeni Varlık Muhasebesi’nde amortisman alanları nasıl çalışır?',
        ...
        aciklama:'**{{amortisman-alani}} = defter.**\n\n' +
                 ...
                 'Pratik sonuç: IFRS raporu ayın herhangi bir gününde ' +
                 '**doğrudur**.\n\n' +
                 'Aynı varlığın iki defterde farklı bakiye taşıması ' +
      ...
      { soru:'Geçişten sonra ay sonu kapanış uzadı. İlk sorulacak soru nedir?',
        ...
        aciklama:'**Cevap bir {{uyumluluk-view}} ise sorun bulunmuştur.**\n\n' +
                 ...
                 'Tipik bulgu: **standart işler hızlanmıştır**, ' +
                 ...
                 '**Ölçüm gerçek hacimle yapılır:** küçük test verisinde ' +
                 'uyumluluk view’i ucuz görünür ve yanıltır.' },
    ...
    flashcards:[
      ...
      { on:'"S/4HANA hızlı" — eksik yarım', arka:'Tamamı: **"UYARLANMIŞ KOD İÇİN hızlı."**\n\nStandart işlemler → hızlanır\nStandart raporlar → hızlanır\n**Özel programlar → yavaşlayabilir**\n\nTeşhis: {{SM37}} → {{SAT}} → {{ST05}}\nÖlçüm **gerçek hacimle**' },
