...
[
  ...
  { id:'master-data', grup:'temeller', title:'Ana Veri', icon:'🗂️', hue:35,
  ...
  /* --------------------------------------------------- Ana Süreçler --- */
  { id:'gl-accounting', grup:'surecler', title:'Ana Muhasebe', icon:'📒', hue:275,
  ...
  { id:'accounts-payable', grup:'surecler', title:'Satıcı Muhasebesi', icon:'📤', hue:20,
    level:'Orta', minutes:55,
  ...
  { id:'accounts-receivable', grup:'surecler', title:'Müşteri Muhasebesi', icon:'📥', hue:340,
    level:'Orta', minutes:55,
  ...
  { id:'asset-accounting', grup:'surecler', title:'Duran Varlık Muhasebesi', icon:'🏭', hue:95,
  ...
  { id:'bank-accounting', grup:'surecler', title:'Banka Muhasebesi', icon:'🏦', hue:230,
  ...
  { id:'document-parking', grup:'islemler', title:'Belge Ön Kaydı', icon:'🅿️', hue:50,
  ...
  { id:'clearing', grup:'islemler', title:'Kapatma', icon:'🔗', hue:180,
    level:'Orta', minutes:45,
  ...
  { id:'special-gl', grup:'islemler', title:'Özel Ana Muhasebe', icon:'🎯', hue:315,
  ...
  { id:'f110', grup:'islemler', title:'Otomatik Ödeme Programı (F110)', icon:'⚡', hue:60,
  ...
  { id:'ebs', grup:'islemler', title:'Elektronik Banka Ekstresi', icon:'🧾', hue:210,
  ...
  { id:'dunning', grup:'islemler', title:'İhtar', icon:'📨', hue:10,
  ...
  { id:'taxes', grup:'islemler', title:'Vergiler', icon:'🧮', hue:75,
  ...
  /* ------------------------------------------------------ Dönem Sonu --- */
  { id:'foreign-currency', grup:'donem-sonu', title:'Kur Değerlemesi', icon:'💱', hue:170,
    level:'İleri', minutes:45,
  ...
  { id:'closing', grup:'donem-sonu', title:'Dönem Kapanışı', icon:'📅', hue:250,
    level:'İleri', minutes:60,
  ...
  { id:'parallel-ledger', grup:'mimari', title:'Paralel Defter', icon:'📚', hue:305,
    level:'İleri', minutes:45,
  ...
  /* ------------------------------------------------------ Entegrasyon --- */
  { id:'cost-center', grup:'entegrasyon', title:'Maliyet Yeri Entegrasyonu', icon:'🎛️', hue:130,
    level:'Orta', minutes:35,
  ...
  { id:'co-integration', grup:'entegrasyon', title:'CO Entegrasyonu', icon:'📊', hue:115,
    level:'İleri', minutes:45,
  ...
  { id:'mm-integration', grup:'entegrasyon', title:'MM Entegrasyonu', icon:'📦', hue:40,
    level:'İleri', minutes:50,
  ...
  { id:'tcodes', grup:'teknik', title:'SAP İşlem Kodları', icon:'⌨️', hue:255,
  ...
  /* ------------------------------------------------- Veri & Geçiş --- */
  { id:'lsmw', grup:'veri', title:'LSMW Veri Aktarımı', icon:'🔧', hue:25,
    level:'İleri', minutes:50,
  ...
  { id:'migration', grup:'veri', title:'Veri Geçişi', icon:'🚚', hue:85,
    level:'İleri', minutes:50,
  ...
  { id:'data-upload', grup:'veri', title:'Veri Yükleme', icon:'⬆️', hue:145,
    level:'Orta', minutes:40,
  ...
  /* ------------------------------------------------- İleri Seviye --- */
  { id:'error-handling', grup:'ileri', title:'Hata Yönetimi', icon:'🚨', hue:15,
    level:'Orta', minutes:45,
  ...
  { id:'best-practices', grup:'ileri', title:'İyi Uygulama İlkeleri', icon:'🏆', hue:105,
    level:'İleri', minutes:40,
