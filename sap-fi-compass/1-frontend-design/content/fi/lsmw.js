...
SAP.registerTopic({
  ...
  surec: {
    ...
    notlar:[
      { tip:'warn', baslik:'Adım 2 geri dönülmesi en pahalı karardır', metin:
        ...
        'Ekran değişirse **bozulur** ve hata mesajı ekran diliyle gelir.' },
    ],
  },
    ...
    liste:[
      { kod:'LSMW', ad:'Legacy System Migration Workbench',
        ...
        ekranAkisi:[
          ...
          { ekran:'Karşılaştırma', islem:'Kaynak dosyada **11 alan** var → 3 eksik' },
          ...
          { ekran:'Mutabakat', islem:'57 hatalı satır {{SM35}}’te kaldı → düzeltilip yeniden' },
        ],
        alanlar:{
  ...
  teknik: {
    ...
    belgeNo:
      '**Geçiş belgeleri için ayrı bir {{belge-turu}} ve numara aralığı tanımlanır.**\n\n' +
    ...
    transport:
      '**LSMW projesi {{tasima-istegi}} ile taşınmaz.** ' +
      'Kendi **dışa/içe aktarma** mekanizması vardır.\n\n' +
    ...
    img:[
      { yol:'LSMW → Dışa aktarma / İçe aktarma', not:'Taşıma isteği **kullanılmaz**' },
      { yol:'OBA7 → Geçiş için özel belge türü', not:'Sonradan süzebilmek için' },
      { yol:'FBN1 → Geçiş belge türü numara aralığı', not:'**Önceki mali yılı** kapsamalı' },
  ...
  s4hana: {
    ozet:
      ...
      'Ayrıca recording yöntemi {{BP}} gibi yeni işlemlerde **güvenilir değil**.',
  ...
  ogrenme: {
    ...
    sikHatalar:[
      ...
      { hata:'BAPI kullanıp commit çağırmamak.', dogru:'BAPI *"başarılı"* döner, kayıt **yazılmaz**. `BAPI_TRANSACTION_COMMIT` zorunlu.' },
    ...
    quiz:[
      ...
      { soru:'Hesap numarası "bulunamadı" hatası veriyor ama hesap sistemde mevcut. En olası sebep?',
        ...
        aciklama:'SAP hesap numarasını **sabit uzunlukta** bekler: ' +
                 ...
                 'Excel bu alanı **sayı** olarak görür ve baştaki sıfırları **atar**. ' +
