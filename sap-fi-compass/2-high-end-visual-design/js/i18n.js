...
(function (SAP) {
  ...
  var DICT = {
    tr: {
      ...
      'hero.lede':       'İş süreci, muhasebe mantığı, işlem kodları ve tablolar — {n} konu, tek bir yerde. Bir kod yaz ya da kaldığın yerden devam et.',
      'hero.parts':      'Dokuz bölüm',
    ...
    en: {
      ...
      'hero.title':      'SAP FI, from transaction code to table.',
      'hero.lede':       'Business process, accounting logic, transaction codes and tables — {n} topics in one place. Type a code or pick up where you left off.',
      'hero.parts':      'Nine parts',
      'cmd.placeholder': 'FB50',
      'cmd.try':         'Try:',
