...
SAP.registerTopic({
  ...
  tanim: {
    ...
    muhasebeMantigi:
      ...
      '**Sonucu şudur: gelir tablosu hesaplarının açılış bakiyesi olmaz.** ' +
  ...
  surec: {
    ...
    roller:[
      ...
      { rol:'Danışman', gorev:'{{hesap-plani}} eşlemesini kurar — **n:1 taşınır, 1:n taşınmaz**.' },
    ...
    diyagram:{
      ...
      adimlar:[
        ...
        { ic:'👥', rol:'Danışman', baslik:'{{cvi}} — satıcı/müşteri → {{is-ortagi}}',
          aciklama:'**Brownfield’de teknik dönüşümden ÖNCE**, hâlâ ECC üzerindeyken. ' +
        ...
        { ic:'⚖️', rol:'Muhasebe', baslik:'{{acilis-bakiyesi}} — geçiş hesabı karşılığında',
          aciklama:'G/L **toplu**, {{acik-kalem}} hesapları **tek tek**, ' +
                   ...
                   'Gelir tablosu hesapları **taşınmaz** — bakiyeleri yoktur.',
        ...
        { ic:'🗓️', rol:'Proje yöneticisi', baslik:'{{kesme-plani}} — dakika dakika',
          aciklama:'Dondur → çek → yükle → mutabakat → onay → aç.\n\n' +
                   'En önemli satır en sonda: **geri dönüş kararı hangi saatte verilir?**',
        ...
        { ic:'🔒', rol:'BT', baslik:'Eski sistem **okunabilir** bırakılır',
    ...
    adimlar:[
      ...
      { rol:'Danışman', eylem:'Hesap planı eşlemesi kurulur', sistem:'n:1 · **1:n değil**' },
      { rol:'Danışman', eylem:'{{cvi}} dönüşümü', sistem:'Dönüşümden **önce**' },
    ...
    notlar:[
      { tip:'warn', baslik:'Yaklaşım kararı geri alınamaz — üç seçeneğin gerçek bedeli', metin:
        ...
        '**Geçmiş gelmez.** Karşılaştırmalı gelir tablosu kendiliğinden oluşmaz. ' +
        ...
        '**Eski sistemin sorunları da gelir.** Yanlış kurulmuş hesap planı dönüşümden ' +
        'sonra da yanlıştır — üstelik artık **daha çok veriyle**.\n' +
        '{{SPDD}}/{{SPAU}} yükü {{z-gelistirme}} sayısıyla doğru orantılıdır.\n' +
      ...
      { tip:'err', baslik:'"Sonra taşırız" diye bir şey yoktur', metin:
  ...
  muhasebe: {
    ...
    etkilenenHesaplar:[
      ...
      { hesap:'600 / 770 (gelir tablosu)', tur:'Sonuç', neden:'**Taşınmaz.** Devreden bakiyeleri yoktur.' },
    ],
    ...
    fisler:[
      { baslik:'① Dönen varlık açılışı — **toplu bakiye**',
        ...
        not:'{{acik-kalem}} yönetimi **olmayan** G/L hesaplarında bakiye yeterlidir; ' +
             ...
             '**İstisna:** açık kalem yönetimi **açık** olan G/L hesapları ' +
      ...
      { baslik:'② Açık satıcı kalemi — **tek tek**',
        ...
        not:'Her açık fatura **ayrı belge** olarak taşınır ve ' +
             ...
             'Toplu taşınırsa: {{F-53}} ödeme yapamaz (kapatılacak kalem yok), ' +
      ...
      { baslik:'③ **YANLIŞ FİŞ** — gelir tablosu hesabı taşımak',
        belgeTuru:'ZE', tarih:'31.12.2027', paraBirimi:'TRY',
        satirlar:[
          { hesap:'399', ad:'Geçiş hesabı', borc:42600000 },
          { hesap:'600', ad:'Yurtiçi satışlar — 2027 cirosu', alacak:42600000,
            not:'bu satır **olmamalıydı**' },
        ],
        not:'**Bu fiş dengelidir, sistem kabul eder ve yine de yanlıştır.**\n\n' +
      ...
      { baslik:'④ Hesap planı bölme (1:n) — **kaynağa dönmeden yapılamaz**',
        ...
        not:'Bu fiş, ①’deki tek `102` satırının yerine geçer.\n\n' +
             ...
             '**1:n taşınamaz** — bir eski hesap iki yeni hesaba bölünüyorsa, ' +
             'eski bakiye **hangi parçanın ne kadar olduğunu taşımaz**. ' +
      ...
      { baslik:'⑤ Duran varlık devri — {{AS91}} muhasebe kaydı **üretmez**',
        ...
        not:'**İki ayrı iş, iki ayrı yer:**\n\n' +
             ...
             '**Amortisman başlangıç tarihi** de taşınmalıdır; ' +
    ...
    notlar:[
      { tip:'tip', baslik:'Üç seviyeli mutabakat — biri diğerinin yerine geçmez', metin:
        ...
        '"Atanmamış hesaplar" satırı **sıfır mı**? ' +
  ...
  cesitler: {
    ...
    liste:[
      ...
      { ad:'{{brownfield}} — sistem dönüşümü', en:'System Conversion',
        ...
        ornek:'**Üç zorunlu adım, sırası değişmez:**\n\n' +
              '**①** {{cvi}} — satıcı/müşteri → {{is-ortagi}} ( dönüşümden **önce**)\n' +
              ...
              '**Üçüncü adım geri alınamaz.** Öncesinde tam yedek alınır ve ' +
      ...
      { ad:'Sınıf 1 · {{ana-veri}}', en:'Master Data',
        ...
        ornek:'Muhasebe kaydı **üretmez** — bu yüzden en düşük riskli sınıftır.\n\n' +
              'Ama en çok **gecikme** buradan çıkar: veri kalitesi sorunları ' +
      ...
      { ad:'Sınıf 2 · {{acilis-bakiyesi}}', en:'Opening Balances',
        aciklama:'Bakiyeler ve açık kalemler.',
        neZaman:'Her yaklaşımda; brownfield’de zaten yerinde durur.',
        ornek:'**Muhasebe kaydı üretir** — en riskli sınıf budur.\n\n' +
      ...
      { ad:'Sınıf 3 · Tarihçe', en:'Historical Data',
        ...
        ornek:'**Konunun asıl kararı bu sınıf yüzünden verilir.**\n\n' +
              ...
              'Türkiye’de ek bir katman var: {{berat}} alınmış dönemler ' +
    ...
    karsilastirma:[
      ...
      ['Karşılaştırmalı gelir tablosu', '**Kendiliğinden oluşmaz**', 'Oluşur'],
      ['Eski hatalar', '**Gelmez**', '**Gelir**'],
      ['Süreç yenileme', 'Doğal fırsat', 'Ayrı proje gerekir'],
      ['{{z-gelistirme}} yükü', 'Sıfırdan seçilir', '{{SPAU}} ile taşınır'],
      ['{{cvi}} dönüşümü', 'Gerekmez — {{is-ortagi}} zaten yeni', '**Ön koşul**'],
      ['Kesme penceresi', 'Genelde uzun', 'Genelde kısa'],
      ['Kullanıcı alışkanlığı', 'Yeniden öğrenilir', 'Büyük ölçüde korunur'],
      ['Geri dönüş', 'Eski sistem çalışmaya devam eder', '**Veritabanı geri yükleme**'],
    ],
  },
    ...
    liste:[
      { kod:'LTMC', ad:'Migration Cockpit — veri geçişi',
        ...
        adimlar:[
          ...
          { baslik:'Doldur ve yükle',
            aciklama:'Sütunları **metin** biçiminde tut — sola sıfır dolgu kaybolmasın.' },
        ...
        ekranAkisi:[
          ...
          { ekran:'Simülasyon', islem:'**847 hata**: 340 vergi no eksik · 89 ülke kodu geçersiz · 418 ödeme koşulu eşlenmemiş' },
        ...
        hatalar:[
          ...
          { mesaj:'Hesap numarası "bulunamadı" ama hesap var', sebep:'**Sola sıfır dolgu** — Excel baştaki sıfırları atmış.', cozum:'Sütun **metin** biçiminde tutulur ({{donusum-kurali}}).' },
          { mesaj:'Şablonda ihtiyacım olan alan yok', sebep:'Standart nesne o alanı kapsamıyor.', cozum:'{{LTMOM}} ile nesne genişletilir. Genişletilen nesne artık **sizin bakımınızdadır**.' },
        ],
      ...
      { kod:'AS91', ad:'Devir varlığı oluştur',
        ...
        adimlar:[
          ...
          { baslik:'Ana veriyi gir — **amortisman başlangıç tarihi dahil**',
          ...
          { baslik:'G/L tarafını **ayrıca** kaydet',
        ...
        ekranAkisi:[
          ...
          { ekran:'İlk {{AFAB}}', islem:'Ocak 2028 amortismanı **beklenen** tutarla karşılaştırıldı' },
        ],
        alanlar:{
  ...
  tablolar: {
    ...
    liste:[
      ...
      { ad:'BUT000', baslik:'CVI dönüşümünün hedefi',
        ...
        alanlar:[
          { ad:'PARTNER', aciklama:'İş ortağı numarası — satıcı numarasıyla **aynı olmak zorunda değil**' },
      ...
      { ad:'LFB1', baslik:'Ayrı yüklenmesi gereken şirket kodu verisi',
        ...
        alanlar:[
          ...
          { ad:'ZTERM', aciklama:'{{odeme-kosulu}} — SAP’ta tanımlı olmalı' },
          { ad:'ZWELS', aciklama:'{{odeme-yontemi}} — boşsa {{F110}} kalemi **öneriye almaz ve hata vermez**' },
        ] },
    ...
    er:{
      ...
      varliklar:[
        ...
        { ad:'LFB1', rol:'3. adım', aciklama:'**Şirket kodu verisi** — ayrı yükleme',
  ...
  sapSurec: {
    ...
    ekranlar:[
      { ad:'{{LTMC}} — Migration Cockpit',
        ...
        alanlar:[
          ...
          { ad:'Eşleme değerleri', zorunlu:false, aciklama:'Eski kod → SAP kodu. ' +
                   '"Boş bırak" kararı yazılı ve onaylı olmalı.' },
        ],
      ...
      { ad:'{{AS91}} — devir varlığı',
        ...
        alanlar:[
          { ad:'**Amortisman başlangıcı**', zorunlu:true, aciklama:'Taşınmazsa kalan ömür ' +
                   'yanlış hesaplanır ve ilk {{AFAB}}’ta ortaya çıkar.' },
          { ad:'Devir değerleri', zorunlu:true, aciklama:'Her {{amortisman-alani}} için **ayrı**.' },
          { ad:'G/L fişi', zorunlu:true, aciklama:'Bu ekranda **değil** — ayrıca kaydedilir.' },
        ],
      ...
      { ad:'{{OB52}} — geçiş dönemi',
        ...
        ipucu:'Geçiş dönemi açık kalırsa canlı kullanıcı yanlışlıkla ' +
    ...
    hatalar:[
      { mesaj:'Satıcı açıldı ama kayıt yapılamıyor', sebep:'{{LFB1}} (şirket kodu verisi) yüklenmemiş.', cozum:'**Ayrı bir yükleme adımıdır.** `AKONT` {{mutabakat-hesabi}} zorunludur.' },
      ...
      { mesaj:'Mizan tutuyor ama {{F.01}} bilançosu tutmuyor', sebep:'**"Atanmamış hesaplar"** satırı dolu — yeni hesap {{mali-tablo-yapisi}}na eklenmemiş.', cozum:'{{OB58}}’de aralık ataması yapılır (bkz. {{konu:reporting}}).' },
      ...
      { mesaj:'CVI dönüşümü binlerce hatayla duruyor', sebep:'Veri kalitesi — mükerrer kayıt, eksik vergi numarası.', cozum:'Bu **danışman işi değildir**. Liste veri sahibine gider; dönüşüm temizlik bitene kadar bekler.' },
    ...
    ipuclari:[
      ...
      'Eski sistemi **kapatma** — yasal saklama süresince okunabilir kalmalı.',
    ],
  },
  ...
  teknik: {
    ...
    commit:
      ...
      'Ama açılış **belgeleri** için aynı garanti yoktur: çok satırlı bir ' +
    ...
    belgeNo:
      '**Geçiş belgeleri için ayrı {{belge-turu}} ve ayrı numara aralığı** tanımlanır.\n\n' +
      'Üç sebep:\n\n' +
      ...
      '**kaldırılır**.\n\n' +
      '**Sık atlanan ayrıntı:** aralık **2027 mali yılını** kapsamalıdır. ' +
    ...
    belgeTuru:
      ...
      'Doldurulmazsa geri dönüşü yoktur: yüklenmiş bir belgeye sonradan ' +
      'referans yazılamaz.',
    ...
    accountDetermination:
      ...
      'Ve bu bir {{tek-yonlu-kapi}}ya yakındır: mutabakat hesabı sonradan ' +
    ...
    img:[
      ...
      { yol:'FBN1 → Geçiş belge türü numara aralığı', not:'**2027 mali yılını** kapsamalı' },
      { yol:'OB52 → Geçiş dönemi', not:'Yükleme sırasında açık, sonra **kapatılır**' },
      { yol:'OB58 → Mali tablo yapısı', not:'Yeni hesaplar atanmazsa bilanço eksik çıkar' },
    ],
    ...
    ekstra:[
      { ic:'🚪', baslik:'Neden "sonra taşırız" mümkün değil — dört engel', metin:
        ...
        '**4. Türkiye’de dönem yasal olarak kesinleşmiştir.**\n' +
      ...
      { ic:'📐', baslik:'n:1 ve 1:n — eşleme matematiği', metin:
        ...
        '**En sık yapılan hata (c)’yi bilmeden yapmaktır:** ' +
    ...
    notlar:[
      ...
      { tip:'warn', baslik:'Geri dönüş planı — yazılmayan tek plan', metin:
        ...
        '{{brownfield}}’de **veritabanı geri yükleme** demektir. ' +
  ...
  s4hana: {
    ...
    eccFarklari:[
      ...
      { konu:'Satıcı/müşteri', ecc:'{{LFA1}} / {{KNA1}} bağımsız', s4:'**{{is-ortagi}} zorunlu** — {{cvi}} ön koşul' },
      { konu:'Açık kalem hedefi', ecc:'{{BSIK}} / {{BSID}} tablolarına yazılır', s4:'Bunlar **görünüm** — belge kaydıyla oluşur' },
    ...
    kalkanTcodes:[
      ...
      { eski:'{{BSIK}}/{{BSID}}’e doğrudan yazma', yeni:'Belge kaydı', not:'Artık **görünüm** — yazılamaz' },
    ...
    compatibilityViews:[
      '{{BSIK}} / {{BSID}} / {{BSIS}} artık **{{uyumluluk-view}}**tir — ' +
    ...
    performans:
      ...
      'Ama {{konu:data-upload}}’daki kural burada da geçerlidir: ' +
    ...
    bestPractices:[
      ...
      '{{cvi}} dönüşümünü brownfield’de **teknik dönüşümden önce** bitir.',
      'Açık kalemleri {{BSIK}}’e yazmaya çalışma — **belge kaydet**.',
      ...
      'Eski sistemin arşiv çözümünü **geçiş projesine dahil et**.',
    ],
  },
  ...
  senaryo: {
    ...
    veriler:[
      ...
      { k:'Taşınmayan', v:'**2027 hareketleri**' },
      { k:'Eski sistem', v:'Şubat’ta **kapatıldı**' },
    ...
    adimlar:[
      { baslik:'SAP’ta 2027 gelir tablosu var mı?', tcode:'F.01',
        ...
        girdi:[
          ...
          { alan:'Sonuç', deger:'**Tüm gelir tablosu hesapları sıfır**' },
      ...
      { baslik:'Mutabakat bunu neden yakalamadı?', tcode:'FS10N',
        ...
        girdi:[
          ...
          { alan:'Yasal mutabakat', deger:'**Yapılmamıştı**' },
        ...
        not:'**Konunun düğüm noktası burada.**\n\n' +
             ...
             'O seviye atlanmıştı çünkü bilanço tutuyordu ve ' +
      ...
      { baslik:'Eski sistemden alınamaz mı?', tcode:'SM37',
        ...
        girdi:[
          { alan:'Eski sistem', deger:'**Şubat’ta kapatıldı** — sunucu iade edildi' },
          { alan:'Gerekçe', deger:'*"Veri taşındı, lisans yenilemeyelim"*' },
          { alan:'Yedek', deger:'Var — ama **ham veritabanı yedeği**' },
          { alan:'Arşiv çözümü', deger:'**Yok** — projeye hiç dahil edilmemişti' },
        ],
        not:'**İkinci karar, birincisinden bağımsız verilmişti ve ' +
      ...
      { baslik:'Ne yapıldı?', tcode:'FB03',
        ...
        girdi:[
          ...
          { alan:'Süre', deger:'**3 hafta** (donanım + lisans + kurulum)' },
        ...
        not:'Çözüm çalıştı ama üç şeye mal oldu: **zaman** (3 hafta), ' +
             ...
             'Ve iş bitmedi: aynı ihtiyaç **her yıl** doğacak. ' +
  ...
  ogrenme: {
    ozet:[
      ...
      '**Gelir tablosu hesaplarının açılış bakiyesi olmaz** — ' +
      ...
      'Eski sistem kapatılmaz; arşiv çözümü **geçiş projesinin parçasıdır**.',
      '**"Sonra taşırız" diye bir şey yoktur** — geçmiş kararı bir {{tek-yonlu-kapi}}dır.',
    ],

    onemliNoktalar:[
      '**"Greenfield mi brownfield mi seçersin?"** Soru maliyetle değil **geçmişle** cevaplanır. **Süreçlerinizden memnunsanız ve tarihçe şartsa** → {{brownfield}} ( eski hatalar da gelir, {{SPAU}} yükü {{z-gelistirme}} sayısıyla artar). **Süreçleri yenilemek istiyorsanız ve tarihçe eski sistemde tutulabiliyorsa** → {{greenfield}} ( karşılaştırmalı gelir tablosu kendiliğinden oluşmaz). İkisi de olmuyorsa {{secici-gecis}} — en pahalısı.',
      '**"Geçen yılın gelir tablosunu yeni sistemde görebilir miyiz?"** **{{greenfield}}\'de hayır** — ve bu bir eksiklik değil, muhasebenin doğası: gelir tablosu hesapları dönem sonunda sıfırlanır ({{bakiye-devri}}), devreden bakiyeleri yoktur. Üç çözüm: (a) önceki yılın **hareketleri** de taşınır, (b) eski sistem **okunabilir** kalır, (c) tablolar dışarıda saklanır. Karar geçişten **önce** verilir; sonradan verilemez.',
    ...
    sikHatalar:[
      ...
      { hata:'Yaklaşım kararını araç seçtikten sonra vermek.', dogru:'Sıra terstir: önce geçmiş kararı, sonra yaklaşım, en son araç.' },
      { hata:'Gelir tablosu hesaplarının bakiyesini taşımak.', dogru:'Fiş dengeli olur, sistem kabul eder ve **yeni yılın gelir tablosu baştan yanlış başlar**.' },
      ...
      { hata:'CVI dönüşümünü teknik dönüşümle birlikte planlamak.', dogru:'**Öncesinde** yapılır — hâlâ ECC üzerindeyken. Gecikmenin ana sebebi veri kalitesidir.' },
      { hata:'Satıcı bakiyesini toplu taşımak.', dogru:'{{acik-kalem}} hesapları **tek tek**; yoksa {{F110}}, {{F-53}} ve {{F150}} çalışmaz.' },
      { hata:'{{LFB1}} yüklemesini atlamak.', dogru:'**Ayrı bir adımdır.** `AKONT` {{mutabakat-hesabi}} olmadan satıcıya kayıt yapılamaz.' },
      { hata:'{{AS91}} sonrası G/L fişini unutmak.', dogru:'AS91 muhasebe kaydı üretmez. Hata yıl sonu {{AJAB}} kapanışında çıkar.' },
      { hata:'Amortisman başlangıç tarihini taşımamak.', dogru:'İlk {{AFAB}} yanlış hesaplar. Geçiş sonrası ilk koşu **elle kontrol edilir**.' },
      { hata:'Geçiş belgelerini normal belge türüyle atmak.', dogru:'Ayrı {{belge-turu}} + ayrı numara aralığı; aralık **önceki mali yılı** kapsamalı.' },
      ...
      { hata:'"Veri taşındı" diyerek eski sistemi kapatmak.', dogru:'Yasal saklama sürer. Arşiv çözümü **geçiş projesinin parçasıdır**.' },
    ...
    ipuclari:[
      ...
      'Temizlik danışmanın değil **veri sahibinin** işidir; liste ona gider.',
    ...
    quiz:[
      { soru:'Veri geçişi projesinde ilk verilmesi gereken karar hangisidir?',
        ...
        aciklama:'**Bu konunun tezi:** geçiş bir veri taşıma işi değil, ' +
                 ...
                 'Ve **geri alınamaz**: canlıya geçtikten sonra ' +
      ...
      { soru:'Greenfield bir geçişte, önceki yılın gelir tablosu yeni sistemde neden oluşmaz?',
        ...
        aciklama:'Bu bir eksiklik değil, **muhasebenin doğasıdır**.\n\n' +
                 ...
                 'Tehlikeli tarafı şu: geçişten sonra **bilanço dolu görünür** ' +
                 've bu, gelir tablosunun boş olduğunu **gizler**. ' +
      ...
      { soru:'Eski sistemdeki tek bir "102 Bankalar" hesabı, yeni sistemde iki hesaba (102.01 / 102.02) bölünecek. Bu nasıl taşınır?',
        ...
        aciklama:'**n:1 taşınır, 1:n taşınmaz.**\n\n' +
                 ...
                 'En sık hata (c)’yi **bilmeden** yapmaktır: ayrıntılı hesap planı ' +
      ...
      { soru:'Brownfield geçişte CVI (müşteri/satıcı → iş ortağı) dönüşümü ne zaman yapılır?',
        ...
        aciklama:'{{is-ortagi}} S/4HANA’da **zorunludur**, bu yüzden {{cvi}} ' +
                 ...
                 'dönüşümü durdurur.\n\n' +
                 'Bu temizlik **danışmanın işi değildir**; hata listesi ' +
      ...
      { soru:'AS91 ile 1.847 varlık devredildi ama mizan tutmuyor. En olası sebep?',
        ...
        aciklama:'**{{AS91}} bir ana veri işlemidir, muhasebe işlemi değil.**\n\n' +
                 ...
                 '**En kötü tarafı zamanlamadır:** unutulursa hata geçişte değil, ' +
      ...
      { soru:'Üç seviyeli mutabakatta "yasal mutabakat" hangi soruyu cevaplar?',
        ...
        aciklama:'Üç seviye **farklı soruları** cevaplar:\n\n' +
                 ...
                 'birebir mi, **"atanmamış hesaplar" satırı sıfır mı**?\n\n' +
      ...
      { soru:'Deneme geçişinin (mock migration) asıl çıktısı nedir?',
        ...
        aciklama:'**Prova, verinin değil PLANIN testidir.**\n\n' +
                 ...
                 '**"Düzeltme" satırı tahmin edilemez** ve yalnızca provada ölçülür: ' +
      ...
      { soru:'Geçiş tamamlandı, mutabakat geçti. Eski sistem ne zaman kapatılabilir?',
        ...
        aciklama:'Sebep lisans maliyeti değil **yasal saklamadır**.\n\n' +
                 'Üç seçenek ve gerçek maliyetleri:\n\n' +
